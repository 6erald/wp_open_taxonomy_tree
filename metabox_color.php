...
function tree_color_add_term_field() {
    ...
    wp_nonce_field( basename( __FILE__ ), 'tree_term_color_nonce' ); ?>

    <div class="form-field tree-term-color-wrap">
        <label for="tree-term-color"><?php _e( 'Color', 'jt' ); ?></label>
        <input type="text" name="tree_term_color" id="tree-term-color" value="#ffffff" class="jt-color-field" data-default-color="#ffffff" />
    </div>
<?php }
...
function tree_color_edit_term_field( $term ) {
    ...
    <tr class="form-field tree-term-color-wrap">
        <th scope="row"><label for="tree-term-color"><?php _e( 'Color', 'jt' ); ?></label></th>
        <td>
            <?php wp_nonce_field( basename( __FILE__ ), 'tree_term_color_nonce' ); ?>
            <input type="text" name="tree_term_color" id="tree-term-color" value="<?php echo esc_attr( $color ); ?>" class="jt-color-field" data-default-color="<?php echo esc_attr( $default ); ?>" />
        </td>
    </tr>
<?php }
